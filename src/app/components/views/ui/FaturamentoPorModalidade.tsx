...
export default function FaturamentoPorModalidade({
  ...
  if (isLoading) {
    return (
      <div className="bg-[var(--cz-superficie)] rounded-[var(--cz-raio-cartao)] border border-[var(--cz-hairline)] p-3 shadow-[var(--cz-elev-1)] animate-pulse h-full">
  ...
  if (modalidades.length === 0) {
    return (
      <div className="bg-[var(--cz-superficie)] rounded-[var(--cz-raio-cartao)] border border-[var(--cz-hairline)] p-3 shadow-[var(--cz-elev-1)] h-full">
