...
function ensureEntry(
  map: Map<string, MutablePendingEntry>,
  input: {
    sku: string;
    produto?: string | null;
  ...
  const created: MutablePendingEntry = {
    sku: input.sku,
...
function serializeEntry(entry: MutablePendingEntry): PendingEntry {
  return {
    ...entry,
...
export async function GET(request: NextRequest) {
  try {
    ...
    const pending = new Map<string, MutablePendingEntry>();
